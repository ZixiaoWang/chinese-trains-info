        ...
        _this.renderFocusedStatus = function () { return (h("div", { className: "page has-input-top" },
            h("div", { className: "field has-addons is-top-input" },
                ...
                h("div", { className: "control is-expanded" },
                    h("input", { type: "text", onChange: _this.onEventChange.bind(_this, 'keyword'), className: "input is-radiusless", placeholder: "\u4ECE\u54EA\u91CC\u51FA\u53D1?" })),
                h("div", { className: "control" },
                    h("a", { className: "button is-radiusless" },
                        h("i", { className: "ion ion-md-send" })))))); };
        return _this;
    }
