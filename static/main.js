...
var Container = function (props) {
    return (h("div", { className: "container" },
        h("div", { className: "columns" },
            h("div", { className: "column is-12" }, props.children))));
};
...
var trainService = (function () {
    var TrainService = /** @class */ (function () {
        function TrainService() {
            var _this = this;
            this.train_list = [];
            this.train_map = new Map();
            this.getList = function (forceUpdate) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this.train_list.length === 0 || !!forceUpdate === true)) return [3 /*break*/, 3];
                                trainListJsonPath = DATA_PATH + 'train_list.json';
                            ...
                            case 2:
                                ...
                                _a.label = 3;
                            case 3: return [2 /*return*/, this.train_list];
                        }
                    });
                });
            };
            this.getMap = function (forceUpdate) {
                if (forceUpdate === void 0) { forceUpdate = false; }
                return __awaiter(_this, void 0, void 0, function () {
                    var list;
                    var _this = this;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this.train_map.size === 0 || !!forceUpdate === true)) return [3 /*break*/, 2];
                                return [4 /*yield*/, this.getList()];
                            case 1:
                                list = _a.sent();
                                list.forEach(function (train, index) {
                                    _this.train_map.set(train.code, train);
                                });
                                _a.label = 2;
                            case 2: return [2 /*return*/, this.train_map];
                        }
                    });
                });
            };
            ...
            this.searchByNo = function (no) {
                if (!no) {
                    return null;
                }
                return _this.train_list
                    .find(function (train, index) {
                    return train.no === no;
                });
            };
            this.searchByFrom = function (keyword) {
                if (!keyword) {
                    return _this.train_list;
                }
            ...
            this.searchByTo = function (keyword) {
                if (!keyword) {
                    return _this.train_list;
                }
                var results = _this.search(keyword);
            ...
            this.searchByFromAndOrTo = function (from, to) {
                var from_lowercase = from.toLowerCase();
                var fromList = _this.searchByFrom(from_lowercase);
                if (!to) {
                    return fromList;
                }
    ...
    var StationService = /** @class */ (function () {
        function StationService() {
            ...
            this.getList = function (forceUpdate) {
                if (forceUpdate === void 0) { forceUpdate = false; }
                return __awaiter(_this, void 0, void 0, function () {
                    var stationsJsonPath, response, stations;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this.station_list.length === 0 || !!forceUpdate === true)) return [3 /*break*/, 3];
                                stationsJsonPath = DATA_PATH + 'station_list.json';
                                return [4 /*yield*/, fetch(stationsJsonPath)];
                            case 1:
                                response = _a.sent();
                                return [4 /*yield*/, response.json()];
                            case 2:
                                ...
                                _a.label = 3;
                            case 3: return [2 /*return*/, this.station_list];
                        }
                    });
                });
            };
            this.getMap = function (forceUpdate) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this.station_map.size === 0 || !!forceUpdate === true)) return [3 /*break*/, 2];
                                return [4 /*yield*/, this.getList()];
                            case 1:
                                list = _a.sent();
                                list.forEach(function (station, index) {
                                    _this.station_map.set(station.name, station);
                                });
                                _a.label = 2;
                            case 2: return [2 /*return*/, this.station_map];
                        }
                    });
                });
            };
            this.search = function (keyword) {
                if (!keyword || keyword.length === 0) {
                    return _this.station_list;
                }
                var lowercase_keyword = keyword.toLowerCase();
                return _this.station_list.filter(function (station) {
                    var name = lodash.get(station, 'name', '').toLowerCase();
                    var pinyin = lodash.get(station, 'pinyin', '').toLowerCase();
                    var abbreviation = lodash.get(station, 'abbreviation', '').toLowerCase();
...
var FromPage = /** @class */ (function (_super) {
    ...
    function FromPage() {
        ...
        _this.focus = function () {
            _this.onValueChange('focus', true);
            setTimeout(function () {
        ...
        _this.renderUnfocusedStatus = function () { return (h(Hero, null,
            h(Container, null,
                h("form", { className: "form" },
                    h("div", { className: "field" },
                        h("div", { className: "content" },
                            h("label", { className: "label" }, "\u7B2C\u4E00\u6B65"),
                            h("p", { className: "is-size-6" }, "\u8BF7\u8BF4\u660E\u60A8\u7684\u51FA\u53D1\u5730"))),
                    h("div", { className: "field" },
                        h("div", { className: "control has-icons-left" },
                            h("input", { type: "text", onClick: _this.focus, className: "input is-rounded", placeholder: "\u4ECE\u54EA\u91CC\u51FA\u53D1?" }),
                            h("span", { className: "icon is-small is-left" },
                                h("i", { className: "ion ion-md-pin" })))))))); };
        _this.renderFocusedStatus = function () { return (h("div", { className: "has-top-input" },
            _this.renderItems(),
            h("div", { className: "field has-addons is-fixed-top" },
                h("div", { className: "control is-expanded" },
                    h("input", { type: "text", ref: _this.searchInput, onKeyUp: _this.onEventChange.bind(_this, 'keyword'), className: "input is-radiusless", placeholder: "\u4ECE\u54EA\u91CC\u51FA\u53D1?" })),
...
function onEventChange(path, event) {
    var state = this.state;
    var target = event.target;
    lodash.set(state, path, target.value);
    this.setState(state);
...
var ToPage = /** @class */ (function (_super) {
    __extends(ToPage, _super);
    function ToPage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = {
            focus: false,
        ...
        _this.renderItems = function () {
            ...
            var items = trainService
                .searchByTo(_this.state.keyword)
        ...
        _this.renderFocusedStatus = function () {
            return (h("div", { className: "has-top-input" },
                _this.renderItems(),
                h("div", { className: "field has-addons is-fixed-top" },
                    h("div", { className: "control is-expanded" },
                        h("input", { type: "text", ref: _this.searchInput, onKeyUp: _this.onEventChange.bind(_this, 'keyword'), className: "input is-radiusless", placeholder: "\u4ECE\u54EA\u91CC\u51FA\u53D1?" })),
        ...
        return (h(Hero, null,
            h(Container, null,
                h("form", { className: "form" },
                    ...
                    h("div", { className: "field" },
                        h("div", { className: "control has-icons-left" },
                            h("input", { type: "text", className: "input is-rounded", placeholder: "\u6211\u60F3\u53BB...", onClick: this.focus }),
                            h("span", { className: "icon is-small is-left" },
...
var RoutesPage = /** @class */ (function (_super) {
    ...
    RoutesPage.prototype.render = function (props) {
        if (this.state.loading) {
            return (h("div", { className: "has-padding-top-7" },
                h(Hero, null,
                    h(Spinner, null)),
                this.renderHeader()));
        }
...
var App = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, stationService.getList()];
                    case 2:
                        _a.sent();
    ...
    App.prototype.render = function () {
        if (this.state.loading) {
            return (h("div", { className: "hero is-fullheight" },
